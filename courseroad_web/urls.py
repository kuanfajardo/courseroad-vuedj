...
urlpatterns = [
    url(r'^$', views.SubjectList.as_view()),
    ...
    url(r'^users/(?P<username>[A-Za-z0-9]+)/buckets/$', views.BucketList.as_view()),
    url(r'^users/(?P<username>[A-Za-z0-9]+)/buckets/(?P<bucket_id>[0-9]+)/$', views.BucketDetail.as_view()),
